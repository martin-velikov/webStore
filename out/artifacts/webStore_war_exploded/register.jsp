        ...
        <div class="container">
            <div class="form-container form-container--small">
                ...
                <form action="RegisterServlet" method="POST" class="login-form">
                    ...
                    <input id="address" type="text" class="form-control" placeholder="Моля, въведете вашият адрес" name="address" pattern="[A-Z\u0400-\u04FFa-z\u0400-\u04FF]{10,120}" title="Твърде кратък и/или неточен адрес" required><br>
