        ...
        <div class="row">
            ...
            <%  if (user != null) {
                if(user.getEmail().equals("admin@admin.ad")) {
                    out.println("                                <form method=\"post\" id=\"alterForm\" action=\"UpdateProductServlet\">\n" +
                            "                                    <input type=\"text\" id=\"alterBrand\" name=\"alterBrand\">\n" +
                            "                                    <input type=\"text\" id=\"alterName\" name=\"alterName\">\n" +
                            "                                    <input type=\"text\" id=\"alterPrice\" name=\"alterPrice\">\n" +
                            "                                    <input type=\"text\" id=\"alterQuantity\" name=\"alterQuantity\">\n" +
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="product-inner">
                                ...
                                <form method="post" action="ShoppingCartServlet" class="cart">
                                    <div class="quantity">
                                        <input type="number" size="4" class="input-text qty text" title="Qty" value="1" name="quantity" min="1" step="1">
                                        <input type="hidden" id="idToCart" name="id">
                                    </div>
...
<script>
    function loadData() {
        var request = new XMLHttpRequest();
        var alterBrand = document.getElementById("alterBrand");
        var alterName = document.getElementById("alterName");
        var alterPrice = document.getElementById("alterPrice");
        var alterDescription = document.getElementById("alterDescription");
        var alterQuantity = document.getElementById("alterQuantity");
        ...
        request.onreadystatechange = function () {
            if (request.readyState == 4) {
                if (request.status === 200) {
                    ...
                    document.getElementById("idToCart").value = productData.id_product;

                    if (alterBrand && alterName && alterPrice && alterDescription && alterQuantity) {
                        document.getElementById("alterBrand").value = productData.product_brand;
                        document.getElementById("alterName").value = productData.product_model;
                        document.getElementById("alterPrice").value = productData.product_price;
